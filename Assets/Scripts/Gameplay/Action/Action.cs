...
namespace Unity.BossRoom.Gameplay.Actions
{
    ...
    public abstract class Action : ScriptableObject
    {
        ...
        /// <summary>
        ///  Called when action is played
        /// </summary>
        /// <returns>false if character is unable to use this action due to lack of mana, true if able and subtracts resource</returns>
        public bool Prestart(ServerCharacter serverCharacter)
        {
            if (serverCharacter.Mana < Config.ManaCost)
            {
                return false;
            }

            serverCharacter.ChangeMana(-Config.ManaCost);
            return true;
        }
