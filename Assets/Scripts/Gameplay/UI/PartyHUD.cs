...
namespace Unity.BossRoom.Gameplay.UI
{
    ...
    public class PartyHUD : MonoBehaviour
    {
        ...
        void SetHeroData(ClientPlayerAvatar clientPlayerAvatar)
        {
            ...
            m_OwnedServerCharacter.NetManaState.Mana.OnValueChanged += SetHeroMana;
        ...
        void SetAllyData(ClientPlayerAvatar clientPlayerAvatar)
        {
            ...
            serverCharacter.NetHealthState.HitPoints.OnValueChanged +=
                (int previousValue, int newValue) => { SetAllyHealth(id, newValue); };

            serverCharacter.NetManaState.Mana.OnValueChanged +=
                (int previousValue, int newValue) => { SetAllyMana(id, newValue); };
        ...
        void SetUIFromSlotData(int slot, ServerCharacter serverCharacter)
        {
            ...
            m_PartyManaSliders[slot].value = serverCharacter.Mana;
